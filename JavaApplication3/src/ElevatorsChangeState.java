...
//				" at floor number " + currentFloorNo);
	 ...
	 *  
	 */
        //may possibly need to change due to the nature of my project. Using the C-scan algorithm and poisson distribuition for generating human traffic. 
        //Elevator is using the c-scan algorithm 
